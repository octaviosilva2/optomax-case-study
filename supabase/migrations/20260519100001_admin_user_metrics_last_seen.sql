-- Fase 5 — RPC admin_user_metrics agora retorna last_seen_at + profile_created_at.
-- "Última atividade" no /admin substitui "Último login" (vide migration
-- 20260519_add_last_seen_at.sql). profile_created_at é fallback para profiles
-- legados (pré-fase-5) que tenham last_seen_at NULL.
--
